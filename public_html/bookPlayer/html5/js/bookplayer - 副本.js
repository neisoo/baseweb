...
//$(document).ready(function () {
	///////////////////////////////////////////////////////////////////////////
	// 将绘图区域移到窗口中间，并进行缩放以适应窗口大小。
        var pageScale = 1;
        var div_w = 1008, div_h = 650;
...
///////////////////////////////////////////////////////////////////////////////
    ...
    //vars
    var nohtml5 = false;
    var IMGHOST = 'http://localhost/photobook/public_html/bookPlayer/artmin';
    var WEBHOST = 'http://localhost/photobook/public_html/bookPlayer';
    var APP_VERSION = '';
    var IOS_VERSION = '';
    var language = 'zhs';
    var text_language = '';
    ...
    var APPLYMASK;
    var PAGEURL = 'http://localhost/photobook/public_html/bookPlayer/html5/bookplayer?cid=12261';
    //ajf	7/15/2013
    var CID = 12261;
    //evt vars
    var lastMouseDown = 0;
    ...
    function checkTour() {
        ...
        if ("/bookplayer" == "/abc/student_home") {
            ...
            addListener('tour_btn', 'click', function () {
                ...
                var video = SoundControl.addVideo(document.body, 'http://localhost/photobook/public_html/bookPlayer/artmin/home/homepage/video/gso_howto_1280x720.mp4', 'content', true, true);
...
*/
  ...
  var userName                  = "希希";
  var bookCID                   = 12261;
  var bookAssetsRootPath        = "http://localhost/photobook/public_html/bookPlayer/artmin";
  var isDev                    = false;
  var isPreview                = false;
  var animationPath             = "/artwork/books/12261/anim/";
...
////////////////////////////////////////////////////////////////////////////
var isFirefox = typeof InstallTrigger !== 'undefined';if (isFirefox) {document.getElementById('small_screen').style.left = '105px';document.getElementById('maindiv').style.width = '1005px';}addListener(window, 'load', bodyOnLoad1); function bodyOnLoad1() {addListener(document, 'contextmenu', function(evt){ evt.preventDefault();}); 
                    ...
                    var gotoshopping = SoundControl.buttonRollover('btn-tickets','http://localhost/photobook/public_html/bookPlayer/artmin/html5/abc/student_homepage/bt/snd/goshopping.mp3');  window.authenticator = new Authenticator();
                    window.userIsParent = false;
                    window.yesnopopup = new YesNoPopup();
                    	assessmentNotification.init();
	Analytics.init({"user":{"profile":{"userId":"2379564311","parentId":"2379564261","memberId":"2379564261","regSource":"1","sGender":"F","sAge":6,"productId":"460","subscriptionType":"SUBSCRIPTION_TYPE_ANNUAL","subscribeDate":"2016-12-25","isSubscribed":true,"assessmentCenter":"FALSE","accountType":"ACCOUNT_TYPE_PARENT","":"CN Site: 04-04-16: Test: International School","path_convert":"some value","insiteVersion2":"CN SHP 2.1.3: 10-06-16: Control: Student Homepage with Things-to-Do Button"}},"page":{"pageInfo":{"language":"zhs","environment":"html5 desktop","pageDetail":"","domain":"localhost:8811","ip":"45.78.34.24","referrer":"http:\/\/localhost:8811\/html5","pathId":"115","learningMode":"free play","url":"http:\/\/localhost:8811\/html5\/bookplayer","urlPath":"html5\/bookplayer","pageWall":"html5 member","pageCategory":"html5 member::activities","pageSection":"html5 member::activities::books"},"media":[]},"valid":true,"transaction":[]});;
	...
	setupVolumes();
	Analytics.start();;
if(decodeURIComponent(getCookie('hashHistory')).split(',').length > 0)
                    hashHistory = decodeURIComponent(getCookie('hashHistory')).split(',');}
